...
width_coefs = [0.1,0.2,0.4,0.6,0.8]
depth_coefs = [0.1,0.2,0.4,0.6,0.8]
resol_coefs = [0.1,0.2,0.4,0.6,0.8]
coefs = [width_coefs, depth_coefs, resol_coefs]
coefs_combis = list(product(*coefs))
epoch = 30
foldername = "241110_effinet1d_combi/241004_10to20sec_3series_merged_orispectrum_normed_noisefiltered/"
...
for coefs_combi in coefs_combis:
    ...
    with open(f"./2.model/{foldername}/{inner_folder}/{filename}_{date}.txt", 'a') as f:     
        ...
        f.write(f"width_coef : {int(32 * coefs_combi[0])} \n")
        
        f.write(f"blocks : {str(blocks_arg)} \n")
