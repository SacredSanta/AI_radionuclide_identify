...
init_ = 0.6
interv = 0.1 
coeff = [round(i*interv + init_, 2) for i in range(0,25,1)]
...
epoch = 30
foldername = f"241113_effinet_combi/{filename}/blocks_arg6/no_poisson/epoch30_try2"
coefs_combis = [[1,1,1]]#[[6.8, 1.0, 0.11],[7.56, 1.0, 0.1]]
phi_flag = 0
