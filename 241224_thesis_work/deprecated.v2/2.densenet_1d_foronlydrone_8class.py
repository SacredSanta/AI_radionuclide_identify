...
foldername = f"241113_densenet1d_combi/previous/8class_all_no_pois"
coefs_combis = [[1,1,1]]
phi_flag = 0
...
#%%
import pandas as pd
pred = np.load("./2.model/241113_densenet1d_combi/previous/8class/1,1,1/predict/241113_count5000down_3series_merged_12000_all_orispec_normed_241107_densenet1d_w1_d1_r1_pred.npy")
