...
if test_make:
    Model = radionuclides_densenet(growth_rate=12, nblocks=[2,4,8,4], width_coef=1, depth_coef=1, resol_coef=1)
...
data_count = 0
data_files = ["241215_set10000_min01040_max01999_all",
              "241215_set10000_min03000_max03999_all",
              "241215_set10000_min05001_max06000_all",
              "241215_set10000_min07000_max08000_all",
              "241215_set10000_min09000_max09999_all",
              "241215_set10000_min11001_max11998_all",
              "241215_set10000_min13000_max13998_all",
              "241215_set10000_min15000_max16000_all"
              ]
...
for coefs_combi in coefs_combis:
    ...
    if data_iteration_mode:
        ...
        data_count += 1
    # -----------------------------------------------------------------------------------------------------------
    foldername = f"241215data_densenet1d_nonpoisson/{filename}/"  #!  <---------- data 마다 수정필요
    # 디렉토리 설정 ------------------------------------------------------------------------------------------------------
    ...
    if coefs_combi[2] != 1:
        ...
        scaled_xtrain = np.zeros((len(x_train), rw, 2))
        scaled_xval = np.zeros((len(x_val), rw, 2))
        scaled_xtest = np.zeros((len(x_test), rw, 2))
    ...
    # 모델 정의
    model = Model
    input_data = tf.random.normal([1, rw, 2])
    ...
    test_x = tf.random.normal(shape=(1,rw,2))
