...
#%% 1. load model (legacy version - .h5)========================================================
...
base_direc = "/tf/latest_version/3.AI/Tensorflow/Code/donghui_prac/2.model"
data_name = "240827_240806-merged_8000__240830_2"   # <-----------이거 고쳐서 이용!
model_direc = base_direc + '/' + data_name + '.keras'
Model = tf.keras.models.load_model(model_direc)
Model.summary()
...
change = 1
if change : data_name = '240827_240806-merged_8000'
...
date = "_240830_2"
np.save(f"./3.predict/{data_name}_pred{date}.npy", pred)
